...
function traiterCommande(transcript) {
    ...
    if(cmd=="ligne" || cmd=="lignes"){
        ...
        if (motCle) {
            ...
            }else if(motCle=='boisson' || motCle=='boissons' || motCle=='Boissons'|| motCle=='Boisson'){
...
function exporterTXT() {
    ...
    const GITHUB_TOKEN  = window.GITHUB_TOKEN || "";   // ⚠️ Token GitHub (scope: repo)
    const GITHUB_OWNER  = "vitalocass";             // Ton nom d'utilisateur GitHub
    const GITHUB_REPO   = "test_mahefa";                 // Ton dépôt
